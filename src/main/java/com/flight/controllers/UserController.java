...
public class UserController {
	 ...
	 * @return will return if user has entered the correct credentials
	 * @version 1.0
	 * @since 05-11-2020
	 */
	@PostMapping("/login")
	public ResponseEntity<?> authenticateUser(@RequestBody AuthLogin authLogin)
	{
		logger.info("authenticateUser method accessed in UserController");
		return userService.authenticateUser(authLogin);
